...
(function(){
  ...
  function normalizeWeather(val){
    ...
    var map = {
      // Optimal
      'sunny':'OPTIMAL','sun':'OPTIMAL','clear':'OPTIMAL','mild':'OPTIMAL','ok':'OPTIMAL','normal':'OPTIMAL','optimal':'OPTIMAL','✅':'OPTIMAL',
      // Extreme heat
      'hot':'EXTREME_HEAT','heat':'EXTREME_HEAT','heat wave':'EXTREME_HEAT','heatwave':'EXTREME_HEAT','extreme heat':'EXTREME_HEAT','🔥':'EXTREME_HEAT',
      // Temperature drop / cold
      'cold':'TEMP_DROP','cold snap':'TEMP_DROP','freeze':'TEMP_DROP','freezing':'TEMP_DROP','temp drop':'TEMP_DROP','❄️':'TEMP_DROP',
      // Rainy / wet
      'rain':'RAINY','rainy':'RAINY','wet':'RAINY','🌧️':'RAINY',
      // Wind
      'wind':'WINDY','windy':'WINDY','storm':'WINDY','💨':'WINDY'
    };
